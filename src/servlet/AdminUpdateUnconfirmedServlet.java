...
@WebServlet(name = "AdminUpdateUnconfirmedServlet", urlPatterns = "/AdminUpdateUnconfirmedServlet")
public class AdminUpdateUnconfirmedServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int line2 = DBConnectionUtil.update("update Property set Name=\""+propertyName+"\",Size="+acres+",IsCommercial="+isCommercial+",isPublic="+isPublic+",Street=\""+street+"\",City=\""+city+"\",Zip="+zip+",ApprovedBy=\""+username+ "\" where ID="+property.getID());
        if (line2 == 0){
        ...
        request.getSession().setAttribute("unconfirmedProperties", UserService.getunconfirmedProperties());
        request.getSession().setAttribute("confirmedProperties", UserService.getconfirmedProperties());
